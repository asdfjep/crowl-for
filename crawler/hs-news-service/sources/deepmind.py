...
class DeepMindCrawler(BaseCrawler):
    def __init__(self):
        super().__init__(name="deepmind", base_url="https://deepmind.google", category="ai")
        self.rss_url = "https://deepmind.google/discover/blog/feed/"
        ...
        try:
            ...
            for item in root.findall(".//item"):
                ...
                news_list.append(NewsItem(
                    title=title, url=link, source="DeepMind",
            ...
            logger.error(f"DeepMind RSS 解析失败: {e}")
        return news_list
